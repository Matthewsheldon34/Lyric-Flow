...
export default function EnterpriseProject({ project, token, onUpdate, onSaveLyric, onDelete }) {
  ...
  return (
    <div className="border-2 border-yellow-400 rounded-lg p-4 bg-yellow-50/10">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-yellow-400 font-bold text-lg">{project.name} (Enterprise)</h3>
        <button onClick={onDelete} className="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded">
          Delete
        </button>
      </div>

      {/* Enterprise Project Controls (Premium + Enterprise) */}
      <div className="mb-3">
      ...
      <div className="mt-4 p-3 bg-yellow-100 rounded text-yellow-900 text-sm">
        <h4 className="font-semibold mb-2">Enterprise-Only Features:</h4>
